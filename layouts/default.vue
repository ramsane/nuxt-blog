<template>
  ...
  <div class="bg-page">
    ...
    >
      <!-- header -->
      <div :class="[$route.fullPath === '/'?  'bg-dark text-primary-100': 'bg-white dark:bg-dark']" class="w-full">
        <header
        ...
        >
          ...
          <nav class="justify-end hidden lg:flex">
            <rs-theme-switcher class="self-center ml-auto"/>
            <nuxt-link
    ...
    <nav
      ...
      :class="[{ 'translate-x-full': !menuClicked }, $route.fullPath === '/'?  'bg-dark text-primary-100': 'bg-white dark:bg-dark']"
    >
      <rs-theme-switcher
